    ...
    always_comb begin
        ...
        case (opcode)
            7'b0110111: begin // LUI
                ...
                dinstr_o.imm      = {instr_i[31:12], 12'b0}; dinstr_o.op = LUI;
            end
            7'b0010111: begin // AUIPC
                dinstr_o.valid    = 1'b1; dinstr_o.rd_used  = 1'b1; dinstr_o.imm_used = 1'b1;
                dinstr_o.imm      = {instr_i[31:12], 12'b0}; dinstr_o.op = AUIPC;
            end
            7'b1101111: begin // JAL 
                dinstr_o.valid    = 1'b1; dinstr_o.is_jump  = 1'b1; dinstr_o.rd_used  = 1'b1; dinstr_o.imm_used = 1'b1;
                dinstr_o.imm      = { {12{instr_i[31]}}, instr_i[19:12], instr_i[20], instr_i[30:21], 1'b0 }; dinstr_o.op = JAL;
            end
            ...
            7'b1100011: begin // BRANCH
                ...
                case (funct3)
                    3'b000: dinstr_o.op = BEQ; 3'b001: dinstr_o.op = BNE; 3'b100: dinstr_o.op = BLT;
                    3'b101: dinstr_o.op = BGE; 3'b110: dinstr_o.op = BLTU; 3'b111: dinstr_o.op = BGEU;
            ...
            7'b0000011: begin // LOAD
                ...
                case (funct3)
                    3'b000: dinstr_o.op = LB; 3'b001: dinstr_o.op = LH; 3'b010: dinstr_o.op = LW;
                    3'b100: dinstr_o.op = LBU; 3'b101: dinstr_o.op = LHU; default: dinstr_o.valid = 1'b0;
                endcase
            end
            ...
            7'b0010011: begin // I-ALU
                ...
                case (funct3)
                    ...
                    3'b100: dinstr_o.op = XORI; 3'b110: dinstr_o.op = ORI; 3'b111: dinstr_o.op = ANDI;
                    3'b001: dinstr_o.op = SLLI;
                    3'b101: begin if (funct7 == 7'b0000000) dinstr_o.op = SRLI; else if (funct7 == 7'b0100000) dinstr_o.op = SRAI; end
                    default: dinstr_o.valid = 1'b0;
                endcase
            end
            7'b0110011: begin // R-ALU
                ...
                case (funct3)
                    3'b000: begin if (funct7 == 7'b0000000) dinstr_o.op = ADD; else if (funct7 == 7'b0100000) dinstr_o.op = SUB; else dinstr_o.valid = 1'b0; end
                    ...
                    3'b101: begin if (funct7 == 7'b0000000) dinstr_o.op = SRL; else if (funct7 == 7'b0100000) dinstr_o.op = SRA; else dinstr_o.valid = 1'b0; end
